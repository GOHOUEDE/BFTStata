...
def nuages(x, y):
    ...
    plt.plot(x, y, marker='o', color='red', linestyle='-', label="commission")
...
def nua(df):
     ...
     fig = px.line(df, x="date", y="commission", markers=True, text=df["commission"],
               title="Évolution des Commissions", labels={"Commission": "date"})
